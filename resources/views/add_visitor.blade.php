...
@section('content')
    ...
    <div class="row mt-4">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header text-center">{{ isset($visitor) ? 'Editar Visitante' : 'Agregar Nuevo Visitante' }}
                </div>
                <div class="card-body">
                    <form id="visitorForm" method="POST"
                        ...
                        <div class="form-group mb-3" style="display:none;">
                            ...
                            <input type="datetime-local" name="visitor_enter_time" class="form-control form-control-lg"
                                value="{{ isset($visitor) ? \Carbon\Carbon::parse($visitor->visitor_enter_time)->format('Y-m-d\TH:i') : '' }}"
                                required />
                        </div>
                        ...
                        <div class="form-group mb-3 text-center">
                            <input type="submit" class="btn btn-primary btn-lg"
                                value="{{ isset($visitor) ? 'Actualizar Visitante' : 'Guardar' }}" />
                        </div>
                    </form>
                </div>
            </div>
