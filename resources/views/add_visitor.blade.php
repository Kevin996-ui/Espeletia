...
@section('content')
    ...
    <div class="visitor-photo-container mb-4">
        <video id="video" autoplay playsinline style="border:1px solid #ccc;"></video>
        <img id="preview" src="" style="display:none; border:1px solid #ccc;">
    </div>
    ...
    <div class="text-center mb-5">
        <button id="captureButton" class="btn btn-success btn-lg">Capturar Cédula</button>
    </div>
                    ...
                    <div class="card-body">
                        <form id="visitorForm" method="POST" action="{{ route('visitor.store') }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="visitor_identity_card" id="visitor_identity_card"
                                    class="form-control form-control-lg" required maxlength="11"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="checkbox" id="isProvider" name="isProvider" class="form-check-input"
                                    value="1" />
                            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="visitorForm" method="POST" action="{{ route('visitor.store') }}"
                        ...
                        <div class="form-group mb-3">
                            <label><b>Cédula de Identidad</b></label>
                            <input type="text" name="visitor_identity_card" class="form-control form-control-lg" required
