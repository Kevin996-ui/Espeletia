    ...
    <div class="mt-4 mb-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <input type="text" name="visitor_card" class="form-control"
                                placeholder="Buscar por Tarjeta de Visitante" value="{{ request('visitor_card') }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <a href="{{ route('visitor.report.export', array_merge(request()->query(), ['format' => 'csv'])) }}"
                            class="btn btn-success">Exportar CSV</a>
                        <a href="{{ route('visitor.report.export', array_merge(request()->query(), ['format' => 'pdf'])) }}"
