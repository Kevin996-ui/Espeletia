...
class SubUserController extends Controller
{
        ...
        if($request->ajax())
        {
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        return '<a href="/sub_user/edit/'.$row->id.'" class="btn btn-primary btn-sm">Editar</a>&nbsp;<button type="button" class="btn btn-danger btn-sm delete" data-id="'.$row->id.'">Eliminar</button>';
                    })
                    ->rawColumns(['action'])
                    ->make(true);
        }
    ...
    function delete($id)
    {
        ...
        return redirect('sub_user')->with('success', 'Datos de usuario eliminados');
    }
}
